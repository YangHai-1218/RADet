...
CLASS_NAMES = ('master_chef_can', 'cracker_box', 'sugar_box', 'tomato_soup_can', 'mustard_bottle', 'tuna_fish_can', 'pudding_box', 'gelatin_box',
...
data = dict(
    ...
    train=dict(
        ...
        dataset_1=dict(
            ...
            img_prefix=data_root + 'train_real/',
            seg_prefix=data_root + 'train_real/',
            ratio=1,
            classes=CLASS_NAMES,
        )
    ),
...
load_from = 'work_dirs/ycbv_r50_radet_pbr/latest.pth'
work_dir = 'work_dirs/ycbv_r50_radet_mixpbr'